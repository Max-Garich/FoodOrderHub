  ...
  return (
    <div className="login-page">
      ...
      <div className="login-seo">
        <p>foodIPThub — сервис онлайн-заказа еды в столовой Ирбитского политехникума (ИПТ).</p>
        <p>Заказ обедов для студентов и преподавателей ИПТ: меню на каждый день, баланс и история заказов.</p>
      </div>
    </div>
  );
}
